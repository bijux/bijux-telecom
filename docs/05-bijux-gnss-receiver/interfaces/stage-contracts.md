...
5. Keep reusable signal math in the [signal package](../../06-bijux-gnss-signal/),
   navigation science in the [navigation package](../../04-bijux-gnss-nav/),
   persisted run interpretation in the [infrastructure package](../../03-bijux-gnss-infra/),
   and operator syntax in the [command package](../../01-bijux-gnss/).
