...
The [core serialization contract](../../02-bijux-gnss-core/foundation/change-principles.md)
governs versioned payload meaning. The
[infrastructure change contract](../../03-bijux-gnss-infra/foundation/change-principles.md)
