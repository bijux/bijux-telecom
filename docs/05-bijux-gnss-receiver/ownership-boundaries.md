...
Move behavior to [signal processing](../06-bijux-gnss-signal/) when it can be
...
results participate in a receiver run. [Navigation science](../04-bijux-gnss-nav/)
owns:
...
[Repository infrastructure](../03-bijux-gnss-infra/) owns:
...
[Shared GNSS contracts](../02-bijux-gnss-core/) define portable request,
...
[Command workflows](../01-bijux-gnss/) define operator syntax, workflow
