...
| --- | --- | --- |
| acquisition | Doppler error, Doppler-bin error, code-phase samples, and code-phase chips. | `crates/bijux-gnss-receiver/tests/integration_acquisition_accuracy_budget.rs` |
| tracking | Carrier error, Doppler error, code-phase error, and CN0 error over stable epochs. | `crates/bijux-gnss-receiver/tests/integration_tracking_accuracy_budget.rs` |
| observation | Pseudorange, carrier phase, Doppler, and CN0 observation errors. | `crates/bijux-gnss-receiver/tests/integration_observations_accuracy_budget.rs` |
| receiver clock and PVT | Position error, clock-bias error, residual RMS, and PDOP. | `crates/bijux-gnss-receiver/tests/integration_navigation_pvt_accuracy_budget.rs`, `crates/bijux-gnss-receiver/tests/integration_navigation_clock_accuracy_budget.rs` |
| serialized evidence | Observed maxima and threshold values survive artifact serialization. | `crates/bijux-gnss-receiver/tests/integration_navigation_accuracy_artifact.rs` |
...
- Changing a field name, unit, or serialized shape is also a core contract
  question; inspect [Numerical Budgets](../../02-bijux-gnss-core/quality/numerical-budgets.md).
...
- `crates/bijux-gnss-receiver/src/sim/synthetic/gnss_artifact_types.rs`
- `crates/bijux-gnss-receiver/src/sim/synthetic/tests/foundation.rs`
- `crates/bijux-gnss-receiver/tests/integration_acquisition_accuracy_budget.rs`
- `crates/bijux-gnss-receiver/tests/integration_navigation_pvt_accuracy_budget.rs`
- `crates/bijux-gnss-receiver/tests/integration_navigation_clock_accuracy_budget.rs`
- `crates/bijux-gnss-receiver/tests/integration_observations_accuracy_budget.rs`
