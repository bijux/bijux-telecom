...
[receiver performance evidence](../05-bijux-gnss-receiver/operations/performance-and-profiling.md)
...
| concern | owner |
| --- | --- |
| operator-facing GNSS commands and reports | [command workflows](../01-bijux-gnss/) |
| signal, receiver, and navigation algorithms or runtime state | the relevant product package |
| product datasets, run manifests, captures, and persisted execution evidence | [repository infrastructure](../03-bijux-gnss-infra/) |
