...
peaks. The [raw-IQ contract](../../06-bijux-gnss-signal/interfaces/raw-iq-and-sample-contracts.md)
defines sample meaning; the infrastructure
[dataset contract](../../03-bijux-gnss-infra/interfaces/dataset-contracts.md)
...
Use the [receiver diagnostic contract](../../05-bijux-gnss-receiver/interfaces/diagnostic-contracts.md)
