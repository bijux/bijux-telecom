...
- runtime:
  use this for behavior owned by the [receiver package](../../05-bijux-gnss-receiver/foundation/package-overview.md),
...
- navigation quality:
  use this only for the [navigation package](../../04-bijux-gnss-nav/foundation/package-overview.md)
