...
- Receiver acquisition, tracking, observation, clock, and PVT thresholds are
  explained in [receiver validation budgets](../../bijux-gnss-receiver/quality/validation-budgets.md).
- Navigation estimator and reference-data claims belong in the
  [navigation test strategy](../../bijux-gnss-nav/quality/test-strategy.md).
