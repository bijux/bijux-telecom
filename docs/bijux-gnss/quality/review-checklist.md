...
| --- | --- | --- |
| CLI name, flag, or output field | Does the public workflow still say exactly what the command can prove? | [command implementation](../../../crates/bijux-gnss/src/cli/), [command contract](../../../crates/bijux-gnss/docs/COMMANDS.md), [CLI reference](../interfaces/cli-reference.md) |
...
| Rust facade export | Is the facade making a durable user entrypoint, not a shortcut around the owning crate? | [facade guide](../../../crates/bijux-gnss/docs/FACADE.md), [public facade](../../../crates/bijux-gnss/src/lib.rs), [facade contracts](../interfaces/facade-contracts.md) |
| report or validation output | Can an operator tell which lower-owner proof backs the report field? | [reporting contracts](../interfaces/reporting-contracts.md), [command test guide](../../../crates/bijux-gnss/docs/TESTS.md) |
...
- The [public facade](../../../crates/bijux-gnss/src/lib.rs) re-exports an
...
- Inspect the [command test guide](../../../crates/bijux-gnss/docs/TESTS.md)
  before accepting a changed test shape.
- Inspect the [facade guide](../../../crates/bijux-gnss/docs/FACADE.md) before
