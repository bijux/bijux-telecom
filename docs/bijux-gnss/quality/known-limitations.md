...
| --- | --- |
| a spreading code, signal model, or DSP primitive is physically correct | [signal quality evidence](../../bijux-gnss-signal/quality/test-strategy.md) |
| acquisition, tracking, observations, or runtime handoff remain correct | [receiver validation guidance](../../bijux-gnss-receiver/quality/change-validation.md) |
| a model, correction, estimator, or integrity decision is scientifically justified | [navigation test strategy](../../bijux-gnss-nav/quality/test-strategy.md) |
| run output is complete, discoverable, and historically durable | [infrastructure test strategy](../../bijux-gnss-infra/quality/test-strategy.md) |
