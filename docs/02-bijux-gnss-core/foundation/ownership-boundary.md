...
| --- | --- | --- |
| signal catalogs, samples, code generation, and DSP | [Signal ownership](../../06-bijux-gnss-signal/foundation/ownership-boundary.md) | reusable signal behavior is not a generic contract |
| orbit products, corrections, estimators, PPP, RTK, and integrity | [Navigation ownership](../../04-bijux-gnss-nav/foundation/ownership-boundary.md) | scientific implementation and acceptance belong with navigation evidence |
| staged execution, channels, tracking sessions, and observations in motion | [Receiver ownership](../../05-bijux-gnss-receiver/foundation/ownership-boundary.md) | runtime state and scheduling are not portable vocabulary |
| datasets, run layout, manifests, provenance, and inspection | [Infrastructure ownership](../../03-bijux-gnss-infra/foundation/ownership-boundary.md) | repository state has persistence and operational semantics |
| commands, flags, output, and workflow composition | [Command ownership](../../01-bijux-gnss/foundation/ownership-boundary.md) | operator behavior is a public product boundary |
