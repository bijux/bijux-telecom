...
[Repository infrastructure](../03-bijux-gnss-infra/) owns the first transition
...
The [receiver handbook](../05-bijux-gnss-receiver/) owns when observations are
...
[Signal processing](../06-bijux-gnss-signal/) owns code families, component
...
[Shared GNSS contracts](../02-bijux-gnss-core/) own portable identities,
...
[Command workflows](../01-bijux-gnss/) select a requested navigation operation,
