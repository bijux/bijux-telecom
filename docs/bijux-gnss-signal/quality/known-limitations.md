...
Use the [receiver limitation guide](../../bijux-gnss-receiver/quality/known-limitations.md)
for lock, handoff, and runtime claims. Use the
[navigation test strategy](../../bijux-gnss-nav/quality/test-strategy.md) for
