...
[receiver dependency boundary](../../bijux-gnss-receiver/foundation/dependencies-and-adjacencies.md).
When it is estimation or correction science, use the
[navigation dependency boundary](../../bijux-gnss-nav/foundation/dependencies-and-adjacencies.md).
