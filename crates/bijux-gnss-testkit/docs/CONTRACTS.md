...
The fixture boundary and its ownership rules are described in the [fixture guide](FIXTURES.md).
...
That evidence surface is described in the [reference data guide](REFERENCE_DATA.md).
...
[truth model guide](TRUTH_MODELS.md).
The antenna and signal-specific test surfaces are described in the
[antenna guide](ANTENNA.md) and [signal guide](SIGNAL.md).
...
The broader crate-level independence rule is described in the [independence guide](INDEPENDENCE.md).
