...
mod tests {
    ...
    fn llh(lon_deg: f64, lat_deg: f64, alt_m: f64) -> Llh {
    ...
    fn validation_case(
        ...
        ValidationCase { month, utc_hours, receiver, satellite, expected_stec_tecu }
    }
            ...
            (
                ...
                [
                    validation_case(
                        4,
                        0.0,
                        llh(297.66, 82.49, 78.11),
                        llh(8.23, 54.29, 20_281_546.18),
                        20.40,
                    ),
                    validation_case(
                        4,
                        0.0,
                        llh(297.66, 82.49, 78.11),
                        llh(-158.03, 24.05, 20_275_295.43),
                        53.45,
                    ),
                    validation_case(
                        4,
            ...
            (
                ...
                [
                    validation_case(
                        4,
                        0.0,
                        llh(40.19, -3.00, -23.32),
                        llh(76.65, -41.43, 20_157_673.93),
                        18.26,
                    ),
                    validation_case(
                        4,
                    ...
                    validation_case(
                        ...
                        4.0,
                        llh(40.19, -3.00, -23.32),
                        llh(107.19, -10.65, 19_943_686.06),
                        76.77,
                    ),
                ],
            ),
            (
                ...
                [
                    validation_case(
                        4,
                        0.0,
                        llh(141.13, 39.14, 117.00),
                        llh(165.14, -13.93, 20_181_976.50),
                        36.44,
                    ),
                    validation_case(
                        4,
