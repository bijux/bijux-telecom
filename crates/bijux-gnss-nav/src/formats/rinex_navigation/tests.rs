...
fn observation(request: ObservationRequest) -> ObsSatellite {
    ObsSatellite {
        signal_id: SigId { sat: request.sat, band: request.band, code: request.code },
        pseudorange_m: Meters(request.pseudorange_m),
        pseudorange_var_m2: 1.0,
        carrier_phase_cycles: Cycles(request.carrier_phase_cycles),
        carrier_phase_var_cycles2: 0.01,
        doppler_hz: Hertz(request.doppler_hz),
        doppler_var_hz2: 1.0,
    ...
    let epoch = ObsEpoch {
        ...
        sats: vec![
            observation(ObservationRequest {
                ...
                band: SignalBand::L1,
                code: SignalCode::Ca,
                pseudorange_m: 20_000_000.125,
                carrier_phase_cycles: 100_000.250,
                doppler_hz: -500.125,
                cn0_dbhz: 45.5,
                cycle_slip: true,
            }),
            observation(ObservationRequest {
                ...
                band: SignalBand::L2,
                code: SignalCode::L2C,
                pseudorange_m: 21_000_000.875,
                carrier_phase_cycles: 110_000.500,
                doppler_hz: -400.500,
                cn0_dbhz: 44.25,
                cycle_slip: false,
            }),
            observation(ObservationRequest {
                ...
                band: SignalBand::E1,
                code: SignalCode::E1B,
                pseudorange_m: 24_000_000.000,
                carrier_phase_cycles: 200_000.000,
                doppler_hz: -250.000,
                cn0_dbhz: 47.0,
                cycle_slip: false,
            }),
