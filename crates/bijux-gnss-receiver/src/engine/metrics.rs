...
struct MetricsSummary {
    ...
    acquisition_cache_miss_cold_start: u64,
    acquisition_cache_miss_incompatible: u64,
...
pub fn write_metrics_summary(
    ...
    let summary = MetricsSummary {
        ...
        acquisition_cache_miss_cold_start: acquisition_stats.cache_miss_cold_start,
        acquisition_cache_miss_incompatible: acquisition_stats.cache_miss_incompatible,
