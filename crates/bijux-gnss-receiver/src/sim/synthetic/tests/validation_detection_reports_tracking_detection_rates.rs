...
fn acquisition_detection_probability_report_tracks_accepted_trials() {
    ...
    let report = measure_truth_guided_acquisition_detection_probability(
        crate::api::sim::SyntheticAcquisitionDetectionProbabilityRequest {
            config: &config,
            ...
            coherent_ms: 1,
            noncoherent: 1,
            trial_seeds: &[24_071_985, 24_071_986],
            scenario_id_prefix: "acquisition-detection-probability",
...
fn tracking_sensitivity_report_counts_stable_lock_and_refusal_trials() {
    ...
    let report = synthetic_tracking_sensitivity_report(
        crate::api::sim::SyntheticTrackingSensitivityReportRequest {
            scenario_id_prefix: "tracking-sensitivity",
            sat,
            cn0_db_hz: 24.0,
            duration_s: 0.06,
