...
fn navigation_covariance_realism_distinguishes_conservative_and_optimistic_profiles() {
    ...
    assert_eq!(drifting_realism.vertical_95.classification, CovarianceCoverageClass::Conservative);
    assert_eq!(
    ...
    assert_eq!(diverging_realism.horizontal_95.classification, CovarianceCoverageClass::Optimistic);
    assert_eq!(diverging_realism.vertical_95.classification, CovarianceCoverageClass::Optimistic);
    assert_eq!(
    ...
    assert!(diverging_realism.position_3d_95.observed_rate.expect("diverging observed rate") < 0.5);
}
