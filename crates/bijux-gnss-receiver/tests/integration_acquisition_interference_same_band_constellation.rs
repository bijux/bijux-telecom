...
#[test]
fn same_band_cross_constellation_interference_reduces_target_detection_probability() {
    ...
    let report = measure_truth_guided_acquisition_interference(
        ...
        &[SyntheticAcquisitionInterferenceCase {
            target_signal: gps_l1_signal(7, 250.0, 300.0, 42.0, 0.0),
            interfering_signals: vec![galileo_e1_signal(11, 250.0, 300.0, 60.0, 0.35)],
            coherent_ms: 20,
            noncoherent: 1,
        }],
        &trial_seeds(0x2820_0102, INTERFERENCE_TRIAL_COUNT),
        "acquisition_interference_same_band_constellation",
        2,
        1,
    );
