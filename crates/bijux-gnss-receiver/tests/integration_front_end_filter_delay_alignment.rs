...
fn synthetic_navigation_validation_run_carries_band_pass_source_and_receiver_delay() {
    ...
    let source_front_end_filter =
        FrontEndFilterSpec::BandPass { center_hz: 400_000.0, bandwidth_hz: 1_000_000.0, taps: 19 };
    let receiver_front_end_filter =
        FrontEndFilterSpec::BandPass { center_hz: 300_000.0, bandwidth_hz: 800_000.0, taps: 23 };
