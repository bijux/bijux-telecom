...
pub use crate::catalog::{
    ...
    shared_path_code_doppler_hz, shared_path_code_rate_hz, shared_path_doppler_hz,
...
pub use crate::dsp::tracking::{
    ...
    code_at, coherent_integration_seconds, correlate_early_prompt_late,
    delay_lock_loop_coefficients, discriminators, dll_hold_threshold, dll_lock_threshold,
    estimate_cn0_dbhz, estimate_tracking_uncertainty, first_order_angular_loop_coefficients,
    first_order_loop_coefficients, fll_lock_threshold_hz, normalize_dll_discriminator,
