...
const GPS_L2C_CM_CODE_ASSIGNMENTS: [GpsL2cCmCodeAssignment; 115] = [
    ...
    GpsL2cCmCodeAssignment { prn: 2, initial_state_octal: 0o756014035, end_state_octal: 0o34445034 },
    ...
    GpsL2cCmCodeAssignment { prn: 20, initial_state_octal: 0o120161274, end_state_octal: 0o143324657 },
    GpsL2cCmCodeAssignment { prn: 21, initial_state_octal: 0o044023533, end_state_octal: 0o110766462 },
    GpsL2cCmCodeAssignment { prn: 22, initial_state_octal: 0o724744327, end_state_octal: 0o602405203 },
    GpsL2cCmCodeAssignment { prn: 23, initial_state_octal: 0o045743577, end_state_octal: 0o177735650 },
    GpsL2cCmCodeAssignment { prn: 24, initial_state_octal: 0o741201660, end_state_octal: 0o630177560 },
    GpsL2cCmCodeAssignment { prn: 25, initial_state_octal: 0o700274134, end_state_octal: 0o653467107 },
    GpsL2cCmCodeAssignment { prn: 26, initial_state_octal: 0o010247261, end_state_octal: 0o406576630 },
    GpsL2cCmCodeAssignment { prn: 27, initial_state_octal: 0o713433445, end_state_octal: 0o221777100 },
    GpsL2cCmCodeAssignment { prn: 28, initial_state_octal: 0o737324162, end_state_octal: 0o773266673 },
    GpsL2cCmCodeAssignment { prn: 29, initial_state_octal: 0o311627434, end_state_octal: 0o100010710 },
    GpsL2cCmCodeAssignment { prn: 30, initial_state_octal: 0o710452007, end_state_octal: 0o431037132 },
    GpsL2cCmCodeAssignment { prn: 31, initial_state_octal: 0o722462133, end_state_octal: 0o624127475 },
    GpsL2cCmCodeAssignment { prn: 32, initial_state_octal: 0o050172213, end_state_octal: 0o154624012 },
    GpsL2cCmCodeAssignment { prn: 33, initial_state_octal: 0o500653703, end_state_octal: 0o275636742 },
    GpsL2cCmCodeAssignment { prn: 34, initial_state_octal: 0o755077436, end_state_octal: 0o644341556 },
    GpsL2cCmCodeAssignment { prn: 35, initial_state_octal: 0o136717361, end_state_octal: 0o514260662 },
    GpsL2cCmCodeAssignment { prn: 36, initial_state_octal: 0o756675453, end_state_octal: 0o133501670 },
    GpsL2cCmCodeAssignment { prn: 37, initial_state_octal: 0o435506112, end_state_octal: 0o641733155 },
