...
use crate::codes::galileo_e5_assignments::{
    galileo_e5a_i_code_assignment, galileo_e5a_q_code_assignment, galileo_e5b_i_code_assignment,
    galileo_e5b_q_code_assignment,
};
use crate::codes::galileo_e5_tables::{GALILEO_E5A_I_SECONDARY_HEX, GALILEO_E5B_I_SECONDARY_HEX};
