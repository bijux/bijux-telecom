...
use bijux_gnss_signal::api::{
    generate_gps_l5_i_code, generate_gps_l5_q_code, gps_l5_i_code_assignment,
    gps_l5_i_neumann_hoffman_code, gps_l5_q_code_assignment, gps_l5_q_neumann_hoffman_code,
};
...
fn gps_l5_i_secondary_overlay_matches_published_sequence() {
    ...
    let windows = vec![
        ReferenceWindow { start: 0, bits: "00001101".to_owned() },
        ReferenceWindow { start: 1, bits: "00011010".to_owned() },
        ReferenceWindow { start: code.len() - 8, bits: "00110101".to_owned() },
        ReferenceWindow { start: code.len() - 4, bits: "01010000".to_owned() },
    ];
...
fn gps_l5_q_secondary_overlay_matches_published_sequence() {
    ...
    let windows = vec![
        ReferenceWindow { start: 0, bits: "00000100".to_owned() },
        ReferenceWindow { start: 6, bits: "00110101".to_owned() },
        ReferenceWindow { start: code.len() - 8, bits: "01001110".to_owned() },
        ReferenceWindow { start: code.len() - 4, bits: "11100000".to_owned() },
    ];
